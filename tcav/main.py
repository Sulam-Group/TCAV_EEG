...
def validate(model):
    model.eval()
    weights = torch.load('/Users/ashen/Desktop/sar/JHU/Course/2023 Spring/EN.580.464 Advanced Data Science for Biomedical Engineering/project/TCAV_PyTorch-master/resnet18_office.pth')
...
if __name__ == "__main__":
    ...
    image_dataset = datasets.ImageFolder('/Users/ashen/Desktop/sar/JHU/Course/2023 Spring/EN.580.464 Advanced Data Science for Biomedical Engineering/project/TCAV_PyTorch-master/data/amazon', data_transforms)
    ...
    concept_dict = {}
    for dirname in os.listdir('/Users/ashen/Desktop/sar/JHU/Course/2023 Spring/EN.580.464 Advanced Data Science for Biomedical Engineering/project/TCAV_PyTorch-master/data/concepts'):
